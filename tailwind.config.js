  ...
  theme: {
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-secondary': 'linear-gradient(135deg, #F43F5E 0%, #FB7185 50%, #FDA4AF 100%)',
        'gradient-subtle': 'linear-gradient(135deg, rgba(79, 70, 229, 0.1) 0%, rgba(99, 102, 241, 0.05) 100%)',
